"""
File from module `pyvelov`. Contains all features required to communicate with API
...
API LICENSE (FR ONLY): https://download.data.grandlyon.com/licences/ETALAB-Licence-Ouverte-v2.0.pdf
